package com.itgrail.grail.codegen.custom.grailddd;
 ...
 **/
@Component
public class GrailDddTemplate extends CustomizedTemplate {
    ...
    public List<ModuleMetaData> initSubModules() {
        ...
        ModuleMetaData moduleMetaData1=new ModuleMetaData().setSubModuleName("client").setPackagingTypes(Lists.newArrayList("jar"));
        ModuleMetaData moduleMetaData2 = new ModuleMetaData().setSubModuleName("core").setPackagingTypes(Lists.newArrayList("jar"));
        ModuleMetaData moduleMetaData3= new ModuleMetaData().setSubModuleName("start").setPackagingTypes(Lists.newArrayList("jar", "war"));
        ...
        if(StringUtils.isNotEmpty(json)){
            ...
            for (ModuleDependencyModel mo:list) {
                ...
                if("core".equals(mo.getModulekey())){
    ...
    public List<String> getSubModules() {
        return Lists.newArrayList("client","core","start");
