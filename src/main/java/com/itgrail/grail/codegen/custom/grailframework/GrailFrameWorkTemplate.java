package com.itgrail.grail.codegen.custom.grailframework;
...
import com.itgrail.grail.codegen.custom.grailframework.metadata.HaloVersionMetaData;
 ...
 **/
@Component
public class GrailFrameWorkTemplate extends CustomizedTemplate {


    @Override
    public String getTemplateName() {
        return "GrailFramework";
    }

    @Override
    public List<ModuleMetaData> initSubModules() {
        List<ModuleMetaData> subModules = Lists.newArrayList();
        ModuleMetaData moduleMetaData1=new ModuleMetaData().setSubModuleName("infrastructure").setPackagingTypes(Lists.newArrayList("jar"));
        ModuleMetaData moduleMetaData2=new ModuleMetaData().setSubModuleName("domain").setPackagingTypes(Lists.newArrayList("jar"));
        ModuleMetaData moduleMetaData3=new ModuleMetaData().setSubModuleName("client").setPackagingTypes(Lists.newArrayList("jar"));
        ModuleMetaData moduleMetaData4=new ModuleMetaData().setSubModuleName("app").setPackagingTypes(Lists.newArrayList("jar"));
        ModuleMetaData moduleMetaData5=new ModuleMetaData().setSubModuleName("start").setPackagingTypes(Lists.newArrayList("jar", "war"));
        ...
        if(StringUtils.isNotEmpty(json)){
            ...
            for (ModuleDependencyModel mo:list) {
                if("infrastructure".equals(mo.getModulekey())){
                    moduleMetaData1.setDependencys(mo.getDependencyModels());
                }
                if("domain".equals(mo.getModulekey())){
                    moduleMetaData2.setDependencys(mo.getDependencyModels());
                }
                if("client".equals(mo.getModulekey())){
                    moduleMetaData3.setDependencys(mo.getDependencyModels());
                }
                if("app".equals(mo.getModulekey())){
                    moduleMetaData4.setDependencys(mo.getDependencyModels());
                }
                if("start".equals(mo.getModulekey())){
                    moduleMetaData5.setDependencys(mo.getDependencyModels());
                }
            }
        }
        subModules.add(moduleMetaData1);
        subModules.add(moduleMetaData2);
        subModules.add(moduleMetaData3);
        subModules.add(moduleMetaData4);
        subModules.add(moduleMetaData5);
        return subModules;
    }

    @Override
    public List<String> getSubModules() {
        return Lists.newArrayList("app","client","domain","start","infrastructure");
    ...
    public GrailFrameworkMetadata getTemplateMetadata() {
        ...
        metadata.setHaloVersions(getHaloVersionMetaDataList());
    ...
    protected List<HaloVersionMetaData> getHaloVersionMetaDataList() {
        HaloVersionMetaData haloVersionMetaData = new HaloVersionMetaData();
        haloVersionMetaData.setGrailFrameworkVersion("1.0.0.RELEASE");
        haloVersionMetaData.setJavaVersion("1.8");
        haloVersionMetaData.setSpringBootVersion("2.4.1");
        haloVersionMetaData.setSpringCloudVersion("2020.0.0");

        HaloVersionMetaData haloVersionMetaData2 = new HaloVersionMetaData();
        haloVersionMetaData2.setGrailFrameworkVersion("1.0.0-SNAPSHOT");
        haloVersionMetaData2.setJavaVersion("1.8");
        haloVersionMetaData2.setSpringBootVersion("2.4.1");
        haloVersionMetaData2.setSpringCloudVersion("2020.0.0");
        return Lists.newArrayList(haloVersionMetaData,haloVersionMetaData2);
    }
    ...
    protected GrailFrameworkGenRequest check(Map<String, Object> request) throws IllegalArgumentException {
        ...
        Preconditions.checkArgument(StringUtils.isNoneBlank(genRequest.getGrailFrameworkVersion()), "haloFrameworkVersion不能为空");
        ...
        for (SubModuleDTO subModuleDTO : genRequest.getSubModules()) {
            Preconditions.checkArgument(subModuleDTO != null, "subModule不能为空");
            Preconditions.checkArgument(StringUtils.isNoneBlank(subModuleDTO.getSubModuleName()), "subModuleName不能为空");
        }
        if (genRequest.getDbModel() != null) {
        ...
        if (genRequest.getDomain() != null) {
            Preconditions.checkArgument(genRequest.getDomain() != null, "domain不能为空");
            Preconditions.checkArgument(StringUtils.isNotBlank(genRequest.getDomain().getCode()), "domain.code不能为空");
            Preconditions.checkArgument(StringUtils.isNotBlank(genRequest.getDomain().getName()), "domain.name不能为空");
            Preconditions.checkArgument(StringUtils.isNotBlank(genRequest.getDomain().getDesc()), "domain.desc不能为空");
        }
